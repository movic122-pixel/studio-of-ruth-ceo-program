...
export default function CEOCurriculumPage() {
  ...
  return (
    <div
      className="min-h-[60vh] text-neutral-800 w-full"
    ...
    >
      ...
      <section className="max-w-6xl mx-auto px-4 py-16 md:py-24 grid md:grid-cols-2 gap-10 items-center">
        <div>
          <h1 className="text-4xl md:text-5xl font-semibold leading-tight">
            The Creative CEO Incubator
            <br />
            Empowering Young Founders
          </h1>
          <p className="mt-5 text-lg text-neutral-700">
            Our signature <span className="font-semibold">Creative CEO Program</span> blends entrepreneurship,
            creative arts, and financial literacy. This page highlights our mission
            and framework while keeping proprietary curriculum content reserved for
            enrolled schools and students.
          </p>
          <div className="mt-6 flex gap-3">
            <a
              href="#pillars"
              className="rounded-full px-4 py-2 bg-neutral-900 text-white text-sm"
            >
              Explore Pillars
            </a>
            <button
            ...
            {[
              ...
              >
                ...
                <p className="mt-3 text-xs text-neutral-500">
                  Core strand, spiraled by age and skill level.
                </p>
              </div>
            ))}
          </div>
      ...
      <section id="pillars" className="max-w-6xl mx-auto px-4 py-14">
        ...
        <p className="mt-3 text-sm text-neutral-600 md:w-3/4">
          These represent the foundation of our incubator model. Each pillar lists sample experiences—not
          full lessons. Full curriculum is provided to enrolled partners only.
        </p>
        ...
        <div className="mt-8 grid md:grid-cols-5 gap-4">
          {[
            ...
            },
            {
              ...
              bullets: ["Budgeting basics", "Profit vs. cost", "Youth micro-ventures"],
            },
            {
              title: "Design & Production",
              bullets: ["Product creation", "Ethical sourcing", "Packaging & presentation"],
            },
            {
            ...
            >
              ...
              <div className="mt-4 text-xs text-neutral-500">
                Detailed modules shared with enrolled partners ✦
              </div>
            </article>
          ))}
        </div>
      ...
      <section className="">
        <div className="max-w-6xl mx-auto px-4 py-14">
          ...
          <p className="mt-2 text-sm text-neutral-600 md:w-3/4">
            The program adapts to the learner’s age and stage—whether they’re exploring identity,
            launching a brand, or scaling their first idea.
          </p>
            ...
            {[
              ...
              },
              {
                ...
                focus: [
                  ...
                  "Logo & brand identity",
                  "Intro to cost & pricing",
                ],
              },
              {
                stage: "Launch Stage",
                focus: ["Business planning", "Marketing & storytelling", "Pitch deck development"],
              },
            ].map((s) => (
              <div
                key={s.stage}
      ...
      <section className="">
        <div className="max-w-6xl mx-auto px-4 py-14">
          ...
          <p className="mt-2 text-sm text-neutral-600 md:w-3/4">
            The Creative CEO Program adapts to the format your school or family needs.
          </p>
          ...
          <ul className="mt-6 space-y-4 text-sm text-neutral-700">
            <li className="flex gap-3">
              ...
              <span>
                <strong>16-Week Semester Program:</strong> 2–3 hours per week, ideal for hybrid and private
                schools.
              </span>
            </li>
            ...
            <li className="flex gap-3">
              ...
              <span>
                <strong>12-Week Studio Series:</strong> Friday evenings at Studio of Ruth for emerging teen
                entrepreneurs.
              </span>
            </li>
            ...
            <li className="flex gap-3">
              ...
              <span>
                <strong>Two-Week Summer Intensive:</strong> 6–8 hour immersive days blending business,
            ...
            <li className="flex gap-3">
              ...
              <span>
                <strong>One-Semester or Year-long Elective:</strong> Weekly 60-minute classes focusing on
          ...
          <p className="mt-4 text-xs text-neutral-500">
            Each structure follows the same core philosophy—creative identity, entrepreneurship, financial
            literacy, leadership, and hands-on production.
          </p>
        </div>
      </section>
      ...
      <section className="">
        <div className="max-w-6xl mx-auto px-4 py-14">
          ...
          <div className="mt-6 grid md:grid-cols-3 gap-5">
            {[
              {
                title: "Entrepreneurial Confidence",
                text: "Learners can articulate their ideas, plan a venture, and speak publicly about their work.",
              },
              {
                title: "Financial Awareness",
                text: "Understands budgeting, pricing, and ethical profit; practices mindful spending.",
              },
              {
                title: "Creative Leadership",
                text: "Applies empathy, communication, and purpose to build community impact.",
              },
            ].map((c) => (
              <article
                key={c.title}
          ...
          <div className="rounded-2xl border border-neutral-200 bg-amber-50 p-6">
            ...
            <ul className="mt-3 space-y-2 text-sm text-neutral-700">
              <li className="flex gap-2">
                <span className="mt-1 w-1.5 h-1.5 rounded-full bg-amber-600" />
                <span>Only program overviews and outcomes are public.</span>
              </li>
              <li className="flex gap-2">
                <span className="mt-1 w-1.5 h-1.5 rounded-full bg-amber-600" />
                <span>Full lesson plans and rubrics shared under NDA.</span>
              </li>
              <li className="flex gap-2">
                <span className="mt-1 w-1.5 h-1.5 rounded-full bg-amber-600" />
                <span>All student identities remain protected per policy.</span>
              </li>
            </ul>
          </div>
        </div>
      ...
      {/* FOOTER */}
      <footer className="border-t border-neutral-200 py-10 text-sm bg-white/50 backdrop-blur">
      ...
      {open && (
        <div className="fixed inset-0 z-[99999] bg-black/40 grid place-items-center p-4 backdrop-blur-sm">
          <div className="w-full max-w-md rounded-2xl bg-white shadow-xl border border-neutral-200 p-6">
            ...
            <div className="flex items-start justify-between gap-6">
              <div>
                ...
                <p className="mt-1 text-sm text-neutral-600">
                  We share the detailed curriculum directly with schools and families.
                </p>
              </div>
              <button
            ...
            <div className="mt-6 grid gap-3">
              <a
                href="mailto:info@studioofruth.com?subject=Creative%20CEO%20Curriculum%20Request&body=Hi%20Studio%20of%20Ruth%2C%0A%0AI%E2%80%99d%20like%20to%20receive%20the%20full%20Creative%20CEO%20curriculum.%20Please%20share%20next%20steps.%0A%0AName%3A%0ASchool%2FOrganization%3A%0ARole%3A%0APhone%3A%0AIdeal%20start%20date%3A%0A%0AThank%20you!"
